...
//  void setSkipEvents(int val) { skipEvents_ = val; }
   ...
   */  
  int run(size_t nInputs, const char* const inputDataFiles[], const char* outputDataFile,
   ...
   */
  int run(const char* catalogFile, const char* outputDataFile,
	  int maxEvents = -1, int skipEvents = 0,
